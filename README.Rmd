...
You can find the source code of the package in our [GitHub](https://github.com/https://github.com/CBMC-GCMP/dafishr) repository or you can install with:
